...
#define the objeective function to maximize or minimize
def getObjective():
...
creator.create("FitnessMax", base.Fitness, weights=(getObjective(),))
...
def evaluate(individual):
    ...
    p = subprocess.Popen(['./GeneticController.sh',str(int(bufferP)),str(int(logF)),
